...
class JsonDecodeFactory {
  T? decode<T>(Map<String, dynamic> json) {
    ...
    if (T == ContraventionCreateWardenCommand) return ContraventionCreateWardenCommand.fromJson(json) as T;
    if (T == ContraventionCreatePhoto) return ContraventionCreatePhoto.fromJson(json) as T;
    if (T == WardenEvent) return WardenEvent.fromJson(json) as T;
    if (T == ContraventionReasonTranslations) return ContraventionReasonTranslations.fromJson(json) as T;
